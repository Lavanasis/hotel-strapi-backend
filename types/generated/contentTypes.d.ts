...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cabinID: Schema.Attribute.Relation<'manyToOne', 'api::cabin.cabin'>;
    cabinPrice: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    endDate: Schema.Attribute.Date;
    extraPrice: Schema.Attribute.Decimal;
    guestID: Schema.Attribute.Relation<'oneToOne', 'api::guest.guest'>;
    guestsNumber: Schema.Attribute.Integer;
    hasBreakfast: Schema.Attribute.Boolean;
    ...
    > &
      Schema.Attribute.Private;
    nightsNumber: Schema.Attribute.Integer;
...
export interface ApiSettingSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    breakfastPrice: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    maxBookingLength: Schema.Attribute.Integer;
    maxGuestsPerBooking: Schema.Attribute.Integer;
    minBookingLength: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
